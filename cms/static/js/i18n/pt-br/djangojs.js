...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "{team_count} Team": [
      "<span class='notranslate'>{team_count}</span> Equipe",
      "<span class='notranslate'>{team_count}</span> Equipes",
      "<span class='notranslate'>{team_count}</span> Equipes"
    ],
    "{totalItems} total": "Total de {totalItems} ",
    "{total_results} result found for \"{search_term}\"": [
      "{total_results} resultado encontrado para &quot; <span class='notranslate'>{search_term}</span> &quot;",
      "{total_results} resultados encontrados para &quot; <span class='notranslate'>{search_term}</span> &quot;",
      "{total_results} resultados encontrados para &quot; <span class='notranslate'>{search_term}</span> &quot;"
    ],
